RSpec.describe PDF417::MessageCompactor do
  describe '#compact' do
    it 'compacts text' do
      compactor = PDF417::MessageCompactor.new('ABCDE')
    ...
    context 'picking a compactor' do
      it 'uses the first compactor to return a non-zero length' do
        ...
        PDF417::MessageCompactor.new('486', compactors: compactors).compact
      ...
      it 'raises an error if a compactor was not chosen' do
        ...
        expect {
          PDF417::MessageCompactor.new('0', compactors: compactors).compact
    ...
    context 'changing compaction mode' do
      ...
      it 'adds codeword 900 to change to text compaction' do
        ...
        compactor = PDF417::MessageCompactor.new(message, compactors: compactors)
        ...
        expect(compactor.compact).to eq([902, 15, 900, 29])
      end
    end
  end
end
